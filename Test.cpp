...
TEST_CASE("Test if the throwable exception for the most of the invalid inputs "
          "is invalid_argument .") {
  for (int i = 10000000; i < 11111111; i = (2 * i) + 5) {
    CHECK_THROWS_AS(snowman(i), invalid_argument);
  }
}
TEST_CASE("Test if it gives a valid value for a between 97656 in base 10 "
          "(11111111 in base 5) to 390624 in base 10 (44444444 in base 5) .") {
...
TEST_CASE("Test if the throwable exception the for most of the invalid inputs "
          "is invalid_argument .") {
  for (int i = 44444445; i < (INT_MAX / 10); i = i + 11111111) {
    CHECK_THROWS_AS(snowman(i), invalid_argument);
  }
}
TEST_CASE("Test if the throwable exception messege for most of the invalid "
          "inputs is Unknown Snowman Dna .") {
  for (int i = 44444445; i < (INT_MAX / 10); i = i + 11111111) {
